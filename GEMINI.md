...
- 2026-01-08 23:10 - Refined Ge'ez/Latin gender detection (default unknown, angel hint) and made neutral mixes fall back to male+female when no neutral master exists; updated docs (engine/workers/voice_cast_builder.py, README.md).
