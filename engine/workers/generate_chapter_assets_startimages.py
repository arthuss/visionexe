...
# WORKFLOW_VIDEO = "wan_2.5" # Not yet available
...
def parse_script(file_path, chapter_name):
    ...
    for part in scene_splits:
        ...
        # 2. VIDEO PROMPTS (Placeholder for future)
...
def main():
    ...
    for ch in chapters:
        ...
        if os.path.exists(script_path):
            tasks = parse_script(script_path, ch)
