...
def build_regie_prompt(scene, action_text, dialog_text, start_image, video_prompt, concept_excerpt):
    return (
        ...
        "- LTX v2 is declarative: actions in order; prefer T2V and only set start_image_mode for true continuity needs.\n"
        "- camera_motion must be one of static/dolly_in/dolly_out/dolly_left/dolly_right/jib_up/jib_down.\n"
        "- camera_lora should match camera_motion (ltx-2-19b-lora-camera-control-...).\n"
